...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check = "SELECT * FROM investors WHERE email='$email'";
...
<head>
  ...
  <title>Investor Register - SheFund</title>
  <style>
    * {
...
<div class="form-container">
  ...
  <a href="investor_login.php" class="link">Already have an account? Login here</a>
</div>
